...
# demo_text = "Worked as Senior developer in Amazon from 2020 to 2024\n MAY 2020falkjflk, 2020 December - present\n 02/2020 03/2025"
finds = re.findall(string = demo_text, pattern = conj_pat)
print(finds)
...
def calculate_experience(range_list:list):
    ...
    for range in range_list:
        dates = re.split(re.compile(rf"(?:[ \t]*{range_separators}[ \t]*|[ \t]+)"), range, maxsplit=1)
        if len(dates) == 2:
    ...
    return (total_experience_months // 12, total_experience_months % 12)
